    ...
    return (
        <div>
            <Menu style={{ backgroundColor: beyaz_gri, margin: '0' }}>
                ...
                <Menu.Item>
                    {renderUserNameArea(currentUser.employee_name)}
                </Menu.Item>
                <Menu.Item>
                    <Icon name="log out" />
                </Menu.Item>
            ...
            >
            <Menu.Item as="a" style={{ color: koyu_gri }} onClick={() => {router.push('/home');}}>
                <Icon name="home" />
                Ana Sayfa
            </Menu.Item>
            ...
            <Menu.Item as="a" style={{ color: koyu_gri }} onClick={() => {router.push('/siparisler');}}>
                <Icon name="truck" />
                Siparişler
            </Menu.Item>
            {/*
